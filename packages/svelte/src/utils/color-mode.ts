 ...
 * inline `style` string to apply on the root `<svg>`. Returns a single
 * CSS-syntax string so Svelte's `style={...}` binding can consume it
 * directly (objects aren't supported there).
 *
